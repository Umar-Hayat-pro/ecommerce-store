class Admin::CategoriesController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_category.save
        ...
        format.json { render :show, status: :created, location: admin_category_url(@admin_category) }
      else
  ...
  def update
    respond_to do |format|
      if @admin_category.update(admin_category_params)
        ...
        format.json { render :show, status: :ok, location: admin_category_url(@admin_category) }
      else
  ...
  private
    ...
    def admin_category_params
      params.expect(category: [ :name, :description, :status ])
    end
end
