  ...
  def create
    ...
    respond_to do |format|
      if @admin_product.save
        ...
        format.json { render :show, status: :created, location: admin_product_url(@admin_product) }
      else
        format.html { render :new, status: :unprocessable_entity }
        format.json { render json: admin_product_url(@admin_product).errors, status: :unprocessable_entity }
      end
    end
  end
  ...
  def update
    respond_to do |format|
      if @admin_product.update(admin_product_params)
        ...
        format.json { render :show, status: :ok, location: admin_product_url(@admin_product) }
      else
